...
datos_merida = circulo(num_datos=N, R=1.5, latitud=20.97537, longitud= -89.61696)
datos_tokio = circulo(num_datos=N, R=1, latitud= 35.6895, longitud=139.69171)
X = np.concatenate([datos_merida, datos_tokio])
X = np.round(X, 3)
print ('X : ', X)
